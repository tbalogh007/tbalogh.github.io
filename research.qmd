...
**"Introducing the Transnational Security Cooperation Agreement Dataset (TSCAD)" with Patrick Bernhard, Nahrain Bet Younadam, Dylan Forrester, Alexandra J. Lazar, Enrico Antonio B. La Viña, Andrew Roskos-Ewoldsen, Daniel Scates, Anya Stewart, and Brandon Kinne.**

- Under review 

Abstract: Nontraditional threats such as terrorism, trafficking, and organized crime increasingly require governments to cooperate across borders. Yet, scholars lack cross-national data on the formal agreements that structure this cooperation. This paper introduces the first dataset on transnational security cooperation agreements (TSCAs). These agreements establish cooperation among civilian security agencies---such as interior ministries, national police, and intelligence agencies---in order to address nontraditional threats. We describe the collection and coding of TSCAD, explain the various types of agreements, and present illustrative applications to terrorism and regime type. TSCAD contains more than 2,000 bilateral agreements from 1980 to 2020, providing scholars with a valuable new resource for studying how governments respond to novel security threats. An R package allows users to tailor TSCA data to specific research applications.
...
- Upcoming presentations at ECPR 2026, EPOP 2026
...
[**"From chatbots to the ballotbox – how voters used AI to learn about the Scottish Parliament election"**](https://www.electionanalysis.uk/scottish-election-analysis-2026/section-1-parties-and-the-campaign/from-chatbots-to-the-ballotbox-how-voters-used-ai-to-learn-about-the-scottish-parliament-election/) **Published in Scottish Parliament Election Analysis 2026. The Campaign, Voters and Policies: Early Reflections from Leading Academics. University of Glasgow. With Louise Luxton, Elise Frelin, and Zoe Greene.**

## Blog posts and news articles

[**"Voters don’t like politicians using AI"**](https://www.electionanalysis.uk/scottish-election-analysis-2026/section-1-parties-and-the-campaign/from-chatbots-to-the-ballotbox-how-voters-used-ai-to-learn-about-the-scottish-parliament-election/) **Published in LSE British Politics and Policy blog. With Louise Luxton, Elise Frelin, and Zoe Greene.**

[**"Auditing AI Chatbots During the Galway West and Dublin Central Byelections"**](https://www.ucd.ie/connected_politics/blog/auditingaichatbotsduringthegalwaywestanddublincentralbyelections/) **Published in the UCD Connected Politics blog. With Eoghan Cunningham, James Cross, Louise Luxton, Timea Balogh, and Derek Greene**